          ...
          <div className="job">
            <div className="center-text job-title">Granite Countertops</div>
              <div className="center">
                ...
                <div>
                  <div>
                    <div className="center-text job-title">After</div>
                  </div>
                  <div className="center">
                    <div>
            ...
            <div className="center-text job-title">Marble Shower Restoration</div>
              ...
              <div className="center">
                <div className="before">
                  ...
                  <div>
                    <img src="https://s3.us-east-2.amazonaws.com/johnmc-site/Screen+Shot+2018-05-03+at+12.51.13+PM.png"></img>
                  </div>
                </div>
                <div>
                  <div>
                  ...
                  <div>
                    <img src="https://s3.us-east-2.amazonaws.com/johnmc-site/Screen+Shot+2018-05-03+at+12.51.05+PM.png"></img>
                  </div>
                </div>
              </div>
              <div className="center-text bottom">The refinishing of this marble shower included polishing and cleaning,regrouting & sealing.</div>
          </div>
          <div className="job">
            <div className="center-text job-title">Marble Floors</div>
              <div className="center">
                <div className="before">
                  <div>
                    <div className="center-text job-title">Before</div>
                  ...
                  <div>
                    <img src="https://s3.us-east-2.amazonaws.com/johnmc-site/marble-kitch-before.png"></img>
                  </div>
                </div>
                <div>
                  <div>
                  ...
                  <div>
                    <img src="https://s3.us-east-2.amazonaws.com/johnmc-site/marble-kitch-after.png"></img>
                  </div>
                </div>
              </div>
